<%-- 
    Document   : musteri
    Created on : 30.Ara.2020, 09:33:20
    Author     : Lenovo
--%>
...
<%@ include file="navbar.jsp" %>
  ...
  <div>
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-add-contact"> Add Staff
    </button>
  </div>
</div>
...
<div class="row">
            ...
            <%  
                                                ...
                                                while (rs.next()) {
                                                    ...
                                                    String isim = rs.getString("p_isim");
                                                    String soyisim = rs.getString("p_soyisim");
                                                     String tel = rs.getString("p_tel");
                                                      String adres= rs.getString("p_adres");
                                                       String eposta = rs.getString("p_eposta");
    ...
    <div class="card card-default p-4">
      <a href="javascript:0" class="media text-secondary" data-toggle="modal" data-target="#modal-contact">
        <img src="assets/img/user/u-xl-1.jpg" class="mr-3 img-fluid rounded" alt="Avatar Image">
            ...
            <c:forEach  items="${staffdelete.jsp}">
               <h5 class="mt-0 mb-2 text-dark"> <%=isim%> <%=soyisim%></h5> 
          <ul class="list-unstyled">
           ...
           <a href="staffdelete.jsp?p_id=<%=rs.getString("p_id") %>">Delete</a>
        <a href="pupdate.jsp?p_id=<%=rs.getString("p_id")%>">update</a>
        </div>
...
<div class="modal fade" id="modal-add-contact" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
        <form action="PKayitOl" method="post" >
          ...
          <div class="row mb-2">
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="p_isim" name="p_isim" >
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="p_soyisim" id="p_soyisim"   >
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="form-group mb-4">
                ...
                <input type="text" class="form-control" id="p_tel" name="p_tel" >
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="form-group mb-4">
                ...
                <input type="email" class="form-control" id="p_eposta" name="p_eposta"  >
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="form-group mb-4">
                ...
                <input type="text" class="form-control" id="p_adres" name="p_adres" >
              </div>
            </div>
