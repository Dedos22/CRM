<%-- 
    Document   : header
    Created on : 05.Kas.2020, 13:27:42
    Author     : Lenovo
--%>
...
<body class="header-fixed sidebar-fixed sidebar-dark header-light" id="body">
          ...
          <div id="sidebar" class="sidebar sidebar-with-footer">
            ...
            <div class="app-brand">
              <a href="/index.html" title="Sleek Dashboard">
                ...
                <span class="brand-name text-truncate">CRM</span>
              </a>
            </div>
              ...
              <ul class="nav sidebar-inner" id="sidebar-menu">
                  ...
                  <li  class="has-sub active expand" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#dashboard"
                      ...
                      <span class="nav-text">PANO</span> <b class="caret"></b>
                    </a>
                   ...
                   <li  class="has-sub" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#app"
                      ...
                      <span class="nav-text">K</span> <b class="caret"></b>
                    </a>
                    <ul  class="collapse"  id="app"
                      ...
                      <div class="sub-menu">
                            ...
                            <li >
                              <a class="sidenav-item-link" href="personel.jsp">
  ...
  <li >
                              <a class="sidenav-item-link" href="musteri.jsp">
