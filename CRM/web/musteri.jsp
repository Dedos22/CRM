...
<div class="row">
            ...
            <%  
                                                ...
                                                while (rs.next()) {
                                                    ...
                                                    String isim = rs.getString("m_isim");
                                                    String soyisim = rs.getString("m_soyisim");
                                                     String tel = rs.getString("m_tel");
                                                      String adres= rs.getString("m_adres");
                                                       String eposta = rs.getString("m_eposta");
                                            %>
  <div class="col-lg-6 col-xl-4">
    ...
    <div class="card card-default p-4">
      <a href="javascript:0" class="media text-secondary" data-toggle="modal" data-target="#modal-contact">
        <img src="assets/img/user/u-xl-1.jpg" class="mr-3 img-fluid rounded" alt="Avatar Image">
            <div class="media-body">
             <c:forEach  items="${costumerdelete.jsp}">
      ...
      <a href="costumerdelete.jsp?m_id=<%=rs.getString("m_id") %>">Delete</a>
          <a href="update.jsp?m_id=<%=rs.getString("m_id")%>">update</a>
        </div>
          ...
          <div class="row mb-2">
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="m_isim" name="m_isim" >
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="m_soyisim" id="m_soyisim"   >
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="form-group mb-4">
                ...
                <input type="email" class="form-control" id="m_eposta" name="m_eposta"  >
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="form-group mb-4">
                ...
                <input type="text" class="form-control" id="m_adres" name="m_adres" >
              </div>
            </div>
